...
class App extends Component {
        ...
        contacts: [
          {
            first: "John",
            last: "Doe",
            address: "1555 Century Avenue, Pudong, Shanghai, China",
            phone: "(+86) 137-6455-5149",
            email: "john.doe@gmail.com"
          },
          {
            first: "Jane",
            last: "Doe",
            address: "3680 Zhangyang Road, Pudong, Shanghai, China",
            phone: "(+86) 137-1325-4674",
            email: "jane.doe@gmail.com"
          },
          {
            first: "Harry",
            last: "Houdini",
            address: "1357 Barroilhet Avenue, Hillsborough, CA, United States",
            phone: "(+1) 650-200-5918",
            email: "harry.houdini@hotmail.com"
          },
          {
            first: "Omar",
            last: "Tariq",
            address: "House 18, Street 10, Sector G-11/1, Islamabad, Pakistan",
            phone: "(+92) 321-455-7810",
            email: "omartariq@yahoo.com"
          },
          {
            first: "James",
            last: "Wang",
            address: "129 Third Avenue, New York, NY, United States",
            phone: "(+1) 450-765-9987",
            email: "jameswang@gmail.com"
          },
          {
            first: "Zareen",
            last: "Mansoor",
            address:
              "House 23, Street 15, Sector C, DHA Phase 1, Karachi, Pakistan",
            phone: "(+92) 311-856-0808",
            email: "z.mansoor@yahoo.com"
          },
          {
            first: "Kate",
            last: "Young",
            address: "900 Willow Road, Suite B, Menlo Park, CA, United States",
            phone: "(+1) 415-376-2690",
            email: "kate_young@gmail.com"
          },
          {
            first: "Rajesh",
            last: "Singh",
            address:
              "New World Complex, Apartment No. 32, Sector 14, Dwarka, New Delhi, India",
            phone: "(+91) 333-559-9876",
          ...
          },
          {
            ...
            last: "Randhawala",
            address:
              "200 Hudson Road, Apartment 1208, Building A, San Francisco, CA, United States",
            phone: "(+1) 651-987-0463",
            email: "amrandhawala@hotmail.com"
          },
          {
            first: "Amina",
            last: "Sabanovic",
            address: "526 Zaozhuang Road, Pudong, Shanghai, China",
            phone: "(+86) 130-5455-6677",
            email: "em3459@yahoo.com"
          }
        ]
      };
    }
  ...
  addPerson(first, last, address, phone, email) {
  ...
  render() {
    ...
    if (this.state.sort === "first") {
      ...
      if (this.state.sort === "last") arrCopy.reverse();
    }

    if (this.state.search !== "") {
      arrCopy = arrCopy.filter(contacts => {
        return (
          contacts.first.match(this.state.search) ||
          contacts.last.match(this.state.search) ||
          contacts.address.match(this.state.search) ||
          contacts.phone.match(this.state.search) ||
          contacts.email.match(this.state.search)
        );
      });
    }
    ...
    const addressBook = arrCopy.map((contacts, i) => {
      return (
        <div key={i} className="contacts" key={i}>
          <h3>
    ...
    return (
      <div className="App">
        ...
        <div className="AddContactForm">
          {!this.state.isHidden && <AddContact onClick={this.addPerson} />}
        </div>
        ...
        <div className="AddButton">
          <Button label="Add +" onClick={this.toggleHidden} />
        </div>
